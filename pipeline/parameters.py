...
def get_parameters():
    ...
    parser.add_argument('--data_splitting_criteria',type=str,default='preprocess_data_randomsplit',
                        choices=['preprocess_data_randomsplit','preprocess_data_cladesplit'])
    ...
    parser.add_argument('--feature_selection_strategy', type=str, required=False, default='lasso_selection_grid',
                        choices=['lasso_selection_grid','lasso_selection_random','lasso_selection_bayes','high_lasso'],
